...
class _TermsScreenState extends ConsumerState<TermsScreen> {
  ...
  Future<String?> _getTermsContent() async {
    ...
    final storedContent = getIt<SharedPrefService>().getString(StorageKeys.appTerms);
    ...
    try {
      ...
      if (versionData != null && versionData.data.termsAndConditions.isNotEmpty) {
        return _cleanHtmlContent(versionData.data.termsAndConditions);
      }
    } catch (e) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('Failed to load terms & conditions', style: theme.textTheme.titleMedium),
                  SizedBox(height: 8.h),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16.h),
                  Text('No terms & conditions available', style: theme.textTheme.titleMedium),
                  SizedBox(height: 8.h),
                  Text('Terms & conditions content is not available', style: theme.textTheme.bodyMedium),
                ],
              ),
            );
          }
