...
class CheckVersionRequest {
  ...
  CheckVersionRequest({this.userId, required this.appVersion, required this.appPlatform, required this.selectedLanguage});

  factory CheckVersionRequest.fromJson(Map<String, dynamic> json) =>
      CheckVersionRequest(userId: json['user_id'], appVersion: json['app_version'], appPlatform: json['app_platform'], selectedLanguage: json['ln']);
