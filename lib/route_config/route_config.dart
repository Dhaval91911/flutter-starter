    ...
    router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          ...
          pageBuilder: (context, state) => state.slidePage(ThemeSwitchScreen()),
        ),
        GoRoute(
        ...
        GoRoute(
          path: Routes.people,
          pageBuilder: (context, state) => state.slidePage(PeopleScreen()),
        ),
        GoRoute(
          path: Routes.network,
          pageBuilder: (context, state) => state.slidePage(NetworkLostScreen()),
        ),
        GoRoute(
          path: Routes.user,
          pageBuilder: (context, state) => state.slidePage(UserScreen()),
        ),
      ],
    );
  }
